...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Source','DocProps','-','Cut','Copy','Paste','PasteText','PasteWord'],
	['Link','Unlink','Anchor'],
	['Image','Table','Rule'],
...
FCKConfig.TemplatesXmlPath	= FCKConfig.EditorPath + 'fcktemplates.xml' ;	['Image','Flash','Table','Rule','Smiley','SpecialChar','PageBreak','UniversalKey'],
...
FCKConfig.LinkBrowserWindowHeight	=	['Image','Flash','Table','Rule','Smiley','SpecialChar','PageBreak','UniversalKey'], FCKConfig.ScreenHeight * 0.7 ;// 70%
