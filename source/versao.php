...
define ('_VERSIONPROG','Publicare 2.9.7 - 18/07/2019');

/*
 * 
 * versao 2.9.4 - Ativado memcache
 * - corrigido bug em sessao de classes indexaveis
 * 
 * versao: 2.9.3 - Adicionadas verificação e proteções para xss e sql injection
 *
        versao: 2.9.2 - Alterada funcionalidade para buscar perfil do usuário no objeto, agora recebe codigo do objeto para verificar pefil em outros objetos alem do que está aberto
 *                      * Diogo Corazolla 17/10/2017

        versao: 2.9.1 - Atualizado componente ADODB
                        - Adicionados comentarios na classe adodb
                        - Trocadas algumas funcoes depreacted
                        * Diogo Corazolla 21/09/2017
