            ...
            <tr>
                ...
                if (!isset($_GET['secao'])) {
                    ...
                    <td class="pblTextoForm" colspan="2" width="390">
                        ...
                        &nbsp;&nbsp;<INPUT type="button" name="btn_secao" value="Pr&eacute;-selecionar" onclick=" return EnviaSecao();" class="pblBotaoForm">
                        <?php
                    } else {
                        ?>
                    <td width="100" class="pblTextoLabelForm">&Aacute;rea Vinculada</td>
                ...
                <tr>
                    ...
                    <td class="pblTextoForm" colspan="3" width="390">
                        ...
                        <SELECT name="cod_usuario" class="pblSelectForm">
                            <OPTION value="0" selected="selected">---NOVO USU&Aacute;RIO---</OPTION>
                            <? echo $_page->_administracao->DropDownUsuarios($_page, $usuario['cod_usuario'], false, $_GET['secao']);?>
                        </SELECT>
                        &nbsp;&nbsp;<INPUT type="submit" name="submit"  value="Selecionar" class="pblBotaoForm" onClick="return valida()">
                        <?php
                    }
                    ?>
                </td>
        ...
        <form action="/index.php/do/gerusuario_post/<?echo $_page->_objeto->Valor($_page, 'cod_objeto')?>.html" method="POST" onsubmit="return ChecaValidade(this);">
                                ...
                                <TABLE WIDTH=370 BORDER=0 CELLPADDING=0 CELLSPACING=8 class="" align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pblTextoForm" valign="bottom">
                                            <INPUT class="pblInputForm" type="password" id="input_senha"  name="senha" value="<? echo isset($usuario['nome'])?$usuario['nome']:"";?>">
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <tr id="trGravarUsr1">
                <td colspan="3" align="right" class="pblTextoForm">
                    ...
                    <INPUT class="pblBotaoForm" type="submit" name="submit" value="Gravar" onclick="trGravarTop2.style.display='';trGravarTop1.style.display='none';">&nbsp;&nbsp;<INPUT class="pblBotaoForm" type="submit" name="apagar" value="Bloquear Usu&aacute;rio" onclick="trGravarUsr1.style.display = 'none';
                            trGravarUsr2.style.display = '';">
                </td>
            </tr>
